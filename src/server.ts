  ...
  "execute",
  {
    ...
    inputSchema: z.object({
      ...
      code: z
        .string()
        .describe(
          "Source code to execute. Use console.log (JS/TS), print (Python/Ruby/Perl/R), echo (Shell), echo (PHP), fmt.Println (Go), print (Dart), or IO.puts (Elixir) to output a summary to context.",
        ),
      timeout: z
        .number()
        .optional()
